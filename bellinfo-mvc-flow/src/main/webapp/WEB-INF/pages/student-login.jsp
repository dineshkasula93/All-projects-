 ...
 <div>
    ...
    <form:form action="${pageContext.request.contextPath}/student" method="post" modelAttribute="student">
     ...
     <option value="MVC">Spring MVC</option>
      ...
      Fee<input type="number"   title="Please enter the Fee" placeholder="Please enter the Fee" name="Fee" /><br><br>
      <div>
        <form:errors path="fee" cssStyle="color:red"></form:errors>
        </div>
      Year<input type="number"  title="Please enter the Year" placeholder="Please enter the Year" name="Year" /><br><br>
       <div>
